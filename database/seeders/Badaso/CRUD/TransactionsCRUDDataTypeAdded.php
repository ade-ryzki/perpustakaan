...
class TransactionsCRUDDataTypeAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            $menu_item = Badaso::model('MenuItem')
                ...
                ->where('url', '/general/transactions')
                ->first();
            ...
            if (!is_null($menu_item)) {
                $menu_item->fill([
                    ...
                    'color' => null,
                    'parent_id' => null,
                    'permissions' => 'browse_transactions',
                    'order' => $order,
                ])->save();
            } else {
                ...
                $menu_item->permissions = 'browse_transactions';
